...
public class App {
    ...
    public static void main(String[] args) {
        ...
        ========== ANSWERS =======================
        Breakpoint 1. sum = 0
        Breakpoint 2. sum = 55, min= 1, max = 10
        Breakpoint 3. sum = 55, min= 1, max = 10, avg = 5.5
        ...
        */
        ...
        avg = sum / (double) numbers.length; // sum = 55, min= 1, max = 10

        System.out.println("Minimum value: " + min);
        System.out.println("Maximum value: " + max);
        System.out.println("Sum: " + sum);
        System.out.println("Average: " + avg); //sum = 55, min= 1, max = 10, avg = 5.5
    }
